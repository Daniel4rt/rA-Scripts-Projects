...
BUILDIN_FUNC(smob)
{
	...
	const char *str	  = script_getstr(st,5);
	int class_        = script_getnum(st,6);
	int size          = script_getnum(st,7);
	int ita           = script_getnum(st,8);
	int pid           = script_getnum(st,9);
	int shp           = script_getnum(st,10);
	int mhp           = script_getnum(st,11);
	int ai            = script_getnum(st,12);
	int nsl           = script_getnum(st,13);
	int ned           = script_getnum(st,14);
	int itd           = script_getnum(st,15);
	int itc           = script_getnum(st,16);
	int wr            = script_getnum(st,17);
	int eb            = script_getnum(st,18);
...
// <--- [zBuffer] List of unit control commands
	...
	// [DanielArt]
	BUILDIN_DEF(smob,"siisiiiiiiiiiiiiii?"),

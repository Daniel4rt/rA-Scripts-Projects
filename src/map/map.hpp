...
inline bool mapdata_allowed_woe(struct map_data *mapdata) {
	...
	if((agit_flag || agit2_flag || agit3_flag) && mapdata->flag[MF_GVG] && (mapdata->flag[MF_GVG_CASTLE] || mapdata->flag[MF_GVG_TE_CASTLE]))
		return true;

...
static int clif_set_unit_idle(struct block_list* bl, unsigned char* buffer, bool spawn, bool hideOpt3 = false);
static int clif_set_unit_walking(struct block_list* bl, struct unit_data* ud, unsigned char* buffer, bool hideOpt3 = false);
